...
class Polygon {
	...
	public static int classID(){
        ...
        public String toString() {
            ...
            //   LabExercise2.Line 1: starts at (20, 30), and ends at (50, 100)
            //   LabExercise2.Line 2: starts at (50, 100), and ends at (100, 30)
            //   LabExercise2.Line 3: starts at (100, 30), and ends at (20, 30)
            //
        	String s = "The Lines in polygon " + objID + " are:\n";

			for(Line l: polygon)
				s += "  " + l.toString()+"\n";
			s = s.trim();  // remove final extra new line
			return s;
    }
}
